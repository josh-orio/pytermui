...
void bind_elements(py::module_ &m) {
  ...
  py::class_<termui::Text>(m, "Text")
      .def(py::init<>())
      .def(py::init<const termui::string &, int, int, int, int>(), py::arg("title"), py::arg("width"),
           py::arg("height"), py::arg("fg_col") = termui::clr::DEFAULT, py::arg("bg_col") = termui::clr::DEFAULT)
      .def(py::init<const std::string &, int, int, int, int>(), py::arg("title"), py::arg("width"), py::arg("height"),
           py::arg("fg_col") = termui::clr::DEFAULT, py::arg("bg_col") = termui::clr::DEFAULT)
      .def("render", &termui::Text::render)
      .def_readwrite("width", &termui::Text::w)
      .def_readwrite("height", &termui::Text::h)
  ...
  py::class_<termui::Input>(m, "Input")
      .def(py::init<>())
      .def(py::init<const termui::string &, const termui::string &, int, int, int>(), py::arg("val"), py::arg("plh"),
           py::arg("width"), py::arg("valCol") = termui::clr::DEFAULT, py::arg("plhCol") = termui::clr::LIGHTGREY)
      .def(py::init<const termui::string &, const std::string &, int, int, int>(), py::arg("val"), py::arg("plh"),
           py::arg("width"), py::arg("valCol") = termui::clr::DEFAULT, py::arg("plhCol") = termui::clr::LIGHTGREY)
      .def(py::init<const termui::string &, int, int>(), py::arg("val"), py::arg("width"),
           py::arg("valCol") = termui::clr::DEFAULT)
      ...
      .def_readwrite("width", &termui::Input::w)
  ...
  py::class_<termui::Button>(m, "Button")
      .def(py::init<>())
      .def(py::init<const termui::string &, int, int, int>(), py::arg("text"), py::arg("width"),
           py::arg("active_color"), py::arg("idle_color"))
      .def(py::init<const std::string &, int, int, int>(), py::arg("text"), py::arg("width"), py::arg("active_color"),
           py::arg("idle_color"))
      ...
      .def_readwrite("width", &termui::Button::w)
  ...
  py::class_<termui::List>(m, "List")
      .def(py::init<const termui::strings &, int, int, int, int>(), py::arg("strs"), py::arg("width"),
           py::arg("height"), py::arg("ls") = 0, py::arg("col") = termui::clr::PASTELPINK)
      .def("getStrings", py::overload_cast<>(&termui::List::getStrings, py::const_),
           py::return_value_policy::reference_internal)
      .def("getStrings", py::overload_cast<>(&termui::List::getStrings), py::return_value_policy::reference_internal)
      .def("getElement", py::overload_cast<int>(&termui::List::getElement, py::const_),
           py::return_value_policy::reference_internal)
      ...
      .def_readwrite("width", &termui::List::w)
      .def_readwrite("height", &termui::List::h)
  ...
  py::class_<termui::SelectList>(m, "SelectList")
      .def(py::init<const termui::strings &, int, int, int, int>(), py::arg("strs"), py::arg("width"),
           py::arg("height"), py::arg("seperation") = 0, py::arg("color") = termui::clr::PASTELPINK)
      .def("getStrings", py::overload_cast<>(&termui::SelectList::getStrings, py::const_),
           py::return_value_policy::reference_internal)
      .def("getStrings", py::overload_cast<>(&termui::SelectList::getStrings),
           py::return_value_policy::reference_internal)
      .def("getElement", py::overload_cast<int>(&termui::SelectList::getElement, py::const_),
           py::return_value_policy::reference_internal)
      .def("getElement", py::overload_cast<int>(&termui::SelectList::getElement),
           py::return_value_policy::reference_internal)
      ...
      .def_readwrite("width", &termui::SelectList::w)
      .def_readwrite("height", &termui::SelectList::h)
  ...
  py::class_<termui::FancyList>(m, "FancyList")
      .def(py::init<const termui::strings &, const termui::strings &, int, int, int, int>(), py::arg("tstrs"),
           py::arg("dstrs"), py::arg("width"), py::arg("height"), py::arg("ls") = 1,
           py::arg("col") = termui::clr::PASTELPINK)
      .def("getText", py::overload_cast<int>(&termui::FancyList::getText, py::const_),
           py::return_value_policy::reference_internal)
      .def("getText", py::overload_cast<int>(&termui::FancyList::getText), py::return_value_policy::reference_internal)
      .def("getDesc", py::overload_cast<int>(&termui::FancyList::getDesc, py::const_),
           py::return_value_policy::reference_internal)
      ...
      .def_readwrite("width", &termui::FancyList::w)
      .def_readwrite("height", &termui::FancyList::h)
  ...
  py::class_<termui::Table>(m, "Table")
      .def(py::init<const termui::strings &, const std::vector<termui::strings> &, std::vector<int>, int, int, int,
                    int>(),
           py::arg("cols"), py::arg("rows"), py::arg("colwidths"), py::arg("table_height"), py::arg("cell_height") = 1,
           py::arg("line_seperation") = 0, py::arg("col") = termui::clr::BLUEPURPLE)
      .def("getCols", py::overload_cast<>(&termui::Table::getCols, py::const_),
           py::return_value_policy::reference_internal)
      ...
      .def("getRow", py::overload_cast<int>(&termui::Table::getRow, py::const_),
           py::return_value_policy::reference_internal)
      .def("getRow", py::overload_cast<int>(&termui::Table::getRow), py::return_value_policy::reference_internal)
      .def("getCell", py::overload_cast<int, int>(&termui::Table::getCell, py::const_),
           py::return_value_policy::reference_internal)
  ...
  py::class_<termui::Box>(m, "Box")
      .def(py::init<int, int, int>(), py::arg("width"), py::arg("height"), py::arg("color"))
      .def("render", &termui::Box::render)
      .def_readwrite("width", &termui::Box::w)
      .def_readwrite("height", &termui::Box::h)
      .def_readwrite("color", &termui::Box::color);

  // --- ProgressBar
  py::class_<termui::ProgressBar>(m, "ProgressBar")
      .def(py::init<int, float, int, int>(), py::arg("width"), py::arg("completion"), py::arg("foregnd_color"),
           py::arg("backgnd_color"))
  ...
  py::class_<termui::DashedArea>(m, "DashedArea")
      ...
      .def_readwrite("width", &termui::DashedArea::w)
      .def_readwrite("height", &termui::DashedArea::h)
