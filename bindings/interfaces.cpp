...
void bind_interfaces(py::module_ &m) {
  py::enum_<termui::state>(m, "State")
      .value("EXIT", termui::state::EXIT)
      .value("CONTINUE", termui::state::CONTINUE)
      .value("SELECT", termui::state::SELECT);

  // --- InfoBox
  py::class_<termui::InfoBox>(m, "InfoBox")
      .def(py::init<const termui::string &, const termui::string &>(), py::arg("title"), py::arg("content"))
      .def(py::init<const std::string &, const std::string &>(), py::arg("title"), py::arg("content"))
  ...
  py::class_<termui::InputBox>(m, "InputBox")
      .def(py::init<const termui::string &, const termui::string &, const termui::string &>(), py::arg("field"),
           py::arg("response"), py::arg("placeholder"))
      .def(py::init<const std::string &, const termui::string &, const std::string &>(), py::arg("field"),
           py::arg("response"), py::arg("placeholder"))
  ...
  py::class_<termui::InputPage>(m, "InputPage")
      .def(py::init<const termui::string &, const termui::strings &, const termui::strings &, int, int>(),
           py::arg("title"), py::arg("fields"), py::arg("responses"), py::arg("seperation") = 0,
           py::arg("color") = termui::clr::PASTELPINK)
  ...
  py::class_<termui::Menu>(m, "Menu")
      .def(py::init<const termui::string &, const termui::strings &, int>(), py::arg("title"), py::arg("items"),
           py::arg("seperation") = 0)
      .def(py::init<const std::string &, const termui::strings &, int>(), py::arg("title"), py::arg("items"),
           py::arg("seperation") = 0)
      .def(py::init<const std::string &, const std::vector<std::string> &, int>(), py::arg("title"), py::arg("items"),
           py::arg("seperation") = 0)
  ...
  py::class_<termui::FancyMenu>(m, "FancyMenu")
      .def(py::init<const termui::string &, const termui::strings &, const termui::strings &, int>(), py::arg("title"),
           py::arg("items"), py::arg("descs"), py::arg("seperation") = 1)
      .def(py::init<const std::string &, const termui::strings &, const termui::strings &, int>(), py::arg("title"),
           py::arg("items"), py::arg("descs"), py::arg("seperation") = 1)
      .def(py::init<const std::string &, const std::vector<std::string> &, const std::vector<std::string> &, int>(),
           py::arg("title"), py::arg("items"), py::arg("descs"), py::arg("seperation") = 1)
  ...
  py::class_<termui::BinaryMenu>(m, "BinaryMenu")
      .def(py::init<const termui::string &, const termui::string &, const termui::string &, const termui::string &>(),
           py::arg("title"), py::arg("text"), py::arg("affirmative"), py::arg("negative"))
  ...
  py::class_<termui::Editor>(m, "Editor")
      .def(py::init<const termui::string &, const termui::string &>(), py::arg("title"), py::arg("content"))
      .def(py::init<const std::string &, const termui::string &>(), py::arg("title"), py::arg("content"))
  ...
  py::class_<termui::Spreadsheet>(m, "Spreadsheet")
      .def(py::init<const termui::string &, const termui::strings &, const std::vector<termui::strings> &>(),
           py::arg("title"), py::arg("columns"), py::arg("data"))
